...
//        uriString= [NSString stringWithFormat:@"http://api.microsofttranslator.com/v2/Http.svc/Translate?text=%@&from=%@&to=%@", [text stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding], from, to];
    }
    else
    {
...
//        uriString= [NSString stringWithFormat:@"http://api.microsofttranslator.com/v2/Http.svc/Translate?&text=%@&to=%@", [text stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding],to];
    }
    
//    NSLog(@"uriString=%@", uriString);
...
- (void)parser:(NSXMLParser *)parser foundCharacters:(NSString *)string
{
    ...
    else if(parser.tag == REQUEST_BREAKSENTENCE_TAG)
    {
        ...
        {
            [_sentencesDict setValue:string forKey:[NSString stringWithFormat:@"%lu", (unsigned long)_sentenceCount]];
